...
export default function Contact() {
  ...
  return (
    ...
    <div style={{ display: 'flex', flexDirection: 'row', marginLeft:"10vw" }}>
      ...
      <div>
        <a href="https://www.linkedin.com/in/md-mushtaq-hussain-b36b73261?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target='_blank'>
          <svg className="h-8 w-8 text-yellow-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
